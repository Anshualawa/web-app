  ...
  return (
    <>
      <div className="px-2 py-2 md:px-6 md:py-10">
        ...
        <hr />
        <div className="mt-8 md:p-5 grid grid-cols-1 gap-8 md:grid-cols-2 xl:mt-12 xl:grid-cols-3 xl:gap-16" style={{ backgroundImage: "url('./building.jpeg')", backgroundSize: 'cover', backgroundPosition: 'center' }}>
          <div className="space-y-3 md:p-5 rounded-xl shadow bg-indigo-200">
